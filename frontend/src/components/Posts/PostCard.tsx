            ...
            >
              {postData.attachments
                ...
                .map((asset, index) => {
                  ...
                  return (
                    <div key={index} className="relative m-1 rounded-xl border border-customBorder bg-slate-950/90 flex items-center justify-center max-h-[32rem] overflow-hidden shadow-sm">
                      {asset.type === 'PHOTO' ? (
                        <>
                          <img
                            src={asset.url}
